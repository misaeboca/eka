	...
	<section id="proyectos">
			<div class="row">
				<div class="row">
					...
					<div class="col s4 m4 ">
						<a href="{{ url('/proyectos/casa_cinco') }}">
					...
					<div class="col s4 m4 ">
						<a href="{{ url('proyectos/the_beer_store') }}">
	...
	<section id="proyectos">
			<div class="row">
				<div class="row">
					...
					<div class="col s4 m4 ">
						<a href="{{ url('/proyectos/truequeria') }}">
