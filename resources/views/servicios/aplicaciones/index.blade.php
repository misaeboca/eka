		...
		<section id="jumbotron" class="servicio diseño">
			...
			<div id="marca" class="row">
				<div class="col s12 m12 flow-text">
					<b style="font-size: 40px; font-weight: 800">TU PRODUCTO ES ÚNICO</b>
				</div>
				<div class="col s12 m12 flow-text">
					<b style="font-size: 20px; font-weight: 800">HAZ QUE TU IMAGEN TAMBIÉN LO SEA</b>
				</div>
				<div class="row ">
					<div class="col s12 m12 img-texto-apli img-t-apli">
						<img  class="responsive-img" src="{{ URL::asset('images/servicios/aplicaciones/botella.png') }}">
						<div class="col s12 m12">
							<div><p>_________  <p></div>
							<span>Tu logo va <br> a ir aquí!</span>
						</div>
					</div>
				</div>
			</div>
			<h4>NO USES PLANTILLAS<br>COMO LOS DEMÁS</h4>
