		...
		<section id="jumbotron" class="servicio diseño">
			...
			<div id="marca" class="row">
				<div class="col s12 m12" style="text-align: left;">
						<h4>¿Vas a abrir tu <br>NUEVO RESTAURANTE ?</h4>
						<h6>¡RESALTA DEL RESTO!</h6>
				</div>
				
		
				<div class="row ">
					<div class="col s12 m12 img-texto-menu img-t-menu">
						<img  class="responsive-img" src="{{ URL::asset('images/servicios/menu/bolsa.png') }}">
